...
export default definePlugin({
    name: "TextReplace2",
    description: "[Hendrik's fork] Replace text in your messages. You can find pre-made rules in the #textreplace-rules channel in Vencord's Server. If you want your rule changes to get imported from the settings.json, you need to reload Discord (CTRL + R).",
